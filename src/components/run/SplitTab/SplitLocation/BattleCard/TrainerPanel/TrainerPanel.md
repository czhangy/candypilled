...
| `isStacked`          | `boolean`            | Yes      | -       | Whether this panel is the bottom-most row of a multi-row battle (a tag battle or a gauntlet/back-to-back fight), rounding only its bottom-left corner and omitting its top border, instead of rounding both left corners as a standalone panel |
