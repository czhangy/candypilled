...
callers that don't already know where the Pokémon was caught. When
...
| `allSpecies`        | `string[]`                                                                                                                                                | Yes      | -       | Every catchable species name, offered in the Pokémon dropdown                                    |
...
| `defaultSpecies`    | `string`                                                                                                                                                  | Yes      | -       | The species the Pokémon dropdown defaults to                                                     |
...
| `onSubmit`          | `(details: Pick<CaughtPokemon, 'ability' \| 'evs' \| 'gender' \| 'ivs' \| 'level' \| 'moves' \| 'name' \| 'nature' \| 'tags'>, location: string) => void` | Yes      | -       | Called with the selected details and the location field's value when the form is submitted       |
| `showLocation`      | `boolean`                                                                                                                                                 | Yes      | -       | Whether to show the Location field, letting the user freeform enter where the Pokémon was caught |
