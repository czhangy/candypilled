...
// per-version game data, so most of it applies unchanged to Pearl. The
// one genuine per-version filter is `version: 'pearl'` itself. Audited
...
// all confirmed accurate for Pearl, not just copied assumptions.
